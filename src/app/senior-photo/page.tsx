...
const FAQ_ITEMS = [
  ...
  { q: 'How long until I get my photos?', a: 'Sneak peek within 72 hours — shareable straight to social. Full gallery in 1-3 weeks depending on the collection. Every image is individually edited. Rush delivery available if you need it sooner.' },
...
export default function SeniorPhoto() {
    ...
    <div className="seniors-page-wrapper">
          ...
          <div className="proc-track">
            ...
            <div className="proc-card">
              ...
              <div className="proc-card-body">
                ...
                <h3>The Gallery</h3>
                <p>Sneak peek within 72 hours — shareable straight to social. Full gallery in 1–2 weeks depending on your package. Download everything, order prints, share freely.</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="pricing">
        ...
        <div className="p-cards">
          <div className="p-card reveal d1">
            ...
            <div className="p-body">
              ...
              <h3 className="p-name">The Edit</h3>
              <div className="p-price"><sup>$</sup>600</div>
              <ul className="p-list">
                <li>1.5 hours of coverage</li>
                <li>1 location</li>
                <li>50+ edited images</li>
                <li>Pic-Time gallery delivery</li>
                <li>Personal print release</li>
                <li>HoneyBook client portal</li>
                <li>H&amp;M add-on available (+$250)</li>
              </ul>
              <p className="p-delivery">Delivery: 2–3 weeks</p>
          ...
          <div className="p-card feat reveal d2">
            ...
            <div className="p-body">
              ...
              <h3 className="p-name">The Feature</h3>
              <div className="p-price"><sup>$</sup>1,000</div>
              <ul className="p-list">
                <li className="hi">2.5 hours of coverage</li>
                <li className="hi">2 locations</li>
                <li className="hi">100+ edited images</li>
                <li>Pic-Time gallery delivery</li>
                <li>Personal print release</li>
                <li>HoneyBook client portal</li>
          ...
          <div className="p-card reveal d3">
            ...
            <div className="p-body">
              ...
              <h3 className="p-name">The Full Story</h3>
              ...
              <ul className="p-list">
                ...
                <li>Personal print release</li>
                <li>HoneyBook client portal</li>
                <li className="hi">Video reel included</li>
                <li className="hi">Hair &amp; makeup included</li>
              </ul>
              <p className="p-delivery">Delivery: 1–2 weeks</p>
              <button className="btn btn-dark btn-full" onClick={() => setIsModalOpen(true)}>Book This Package</button>
            </div>
          </div>
        </div>
        <div className="addons-bar reveal">
          <p>
            <strong>Senior Add-Ons</strong><br />
            Video Reel (Base / Mid packages) +$300 &nbsp;&bull;&nbsp; Hair &amp; Makeup +$350 &nbsp;&bull;&nbsp; Multi-Season Package +$400 &nbsp;&bull;&nbsp; H&amp;M Add-On (Base / Mid packages) +$250.
          </p>
